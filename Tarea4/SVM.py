...
def main():
	...
	print("> Entrenando ...")
	clf = svm.SVC(C=1.0, kernel='rbf', degree=4, gamma='scale', coef0=0.0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False, max_iter=-1, decision_function_shape='ovr', random_state=None)
